...
#define STRING_CONFIG_H_AUTHOR "(chand1012, Ender-3)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.88, 79.48, 398.60, 106.29 }
...
// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_SPEED XY_PROBE_FEEDRATE

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST Z_PROBE_FEEDRATE_FAST

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW Z_PROBE_FEEDRATE_SLOW
